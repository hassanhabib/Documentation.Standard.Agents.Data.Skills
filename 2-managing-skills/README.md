...
> Status: the three subsections below are sketched, not yet locked.
...
the *hot* detection an agent performs at runtime (see 1.0). Runtime collision events
emitted as Output (see 1.2) are ingested here.
